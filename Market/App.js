...
{
fetch('https://dps-api.000webhostapp.com/apiusuario.php?comando=autenticar&usuario='+this.state.usuario+'&contrasena='+this.state.contrasena, {
method: 'GET'
})
...
{
console.log('Prueba');
fetch('https://dps-api.000webhostapp.com/api.php?comando=listar', {
method: 'GET'
})
.then((response) => response.json())
.then((responseJson) => {
...
Actualizar()
{
fetch('https://dps-api.000webhostapp.com/api.php?comando=editar&nombre='+this.state.nombre
...
Eliminar()
{
fetch('https://dps-api.000webhostapp.com/api.php?comando=eliminar&id='+this.state.id, {
method: 'GET'
})
.then((response) => response.json())
.then((responseJson) => {
...
headerStyle: {
  ...
  Guardar()
  {
  fetch('https://dps-api.000webhostapp.com/api.php?comando=agregar&nombre='+this.state.nombre
  +'&descripcion='+this.state.descripcion
  +'&cantidad='+this.state.cantidad
  +'&preciodecosto='+this.state.preciodecosto
  +'&preciodeventa='+this.state.preciodeventa
